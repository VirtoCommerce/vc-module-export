...
namespace VirtoCommerce.ExportModule.Data.Services
{
    public class PlatformExportImportManager : IPlatformExportImportManager
    {
        ...
        {
            return reader.DeserializeJsonArrayWithPagingAsync<Role>(jsonSerializer, _batchSize, async items =>
            {
        ...
        {
            return reader.DeserializeJsonArrayWithPagingAsync<ApplicationUser>(jsonSerializer, _batchSize, async items =>
            {
        ...
        {
            return reader.DeserializeJsonArrayWithPagingAsync<ObjectSettingEntry>(jsonSerializer, int.MaxValue, async items =>
            {
        ...
        {
            return reader.DeserializeJsonArrayWithPagingAsync<DynamicProperty>(jsonSerializer, _batchSize,
        ...
        {
            return reader.DeserializeJsonArrayWithPagingAsync<DynamicPropertyDictionaryItem>(jsonSerializer, _batchSize,
        ...
        {
            return reader.DeserializeJsonArrayWithPagingAsync<UserApiKey>(jsonSerializer, _batchSize,
