angular.module('virtoCommerce.exportModule')
    .controller('virtoCommerce.exportModule.legacy.importMainController', ['$scope', 'platformWebApp.bladeNavigationService', 'virtoCommerce.exportModule.legacy.resource', 'FileUploader', function ($scope, bladeNavigationService, exportImportResourse, FileUploader) {
        ...
        blade.toolbarCommands = [
            {
                name: "export.blades.import-main.labels.start-import",
                icon: "fa fa-download",
