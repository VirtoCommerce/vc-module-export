angular.module('virtoCommerce.exportModule')
    .controller('virtoCommerce.exportModule.legacy.exportMainController', ['$scope', 'platformWebApp.bladeNavigationService', 'virtoCommerce.exportModule.legacy.resource', 'platformWebApp.authService', 'platformWebApp.toolbarService', function ($scope, bladeNavigationService, exportImportResourse, authService, toolbarService) {
        var blade = $scope.blade;
        blade.headIcon = 'fa fa-upload';
        blade.title = 'export.blades.export-main.title';
