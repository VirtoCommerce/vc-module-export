angular.module('virtoCommerce.exportModule')
    .controller('virtoCommerce.exportModule.legacy.importSampleDataWidgetController', ['$scope', '$window', 'platformWebApp.dialogService', function ($scope, $window, dialogService) {
