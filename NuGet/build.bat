...
"%MSBUILD_PATH%" "%SOURCE_DIR%\VirtoCommerce.ExportModule.sln" /nologo /verbosity:m /t:Build /p:Configuration=Release;Platform="Any CPU"


nuget pack "%SOURCE_DIR%\VirtoCommerce.ExportModule.Data\VirtoCommerce.ExportModule.Data.csproj" -IncludeReferencedProjects -Symbols -Properties Configuration=Release -o "%TARGET_DIR%"
nuget pack "%SOURCE_DIR%\VirtoCommerce.ExportModule.Web.Core\VirtoCommerce.ExportModule.Web.Core.csproj" -IncludeReferencedProjects -Symbols -Properties Configuration=Release -o "%TARGET_DIR%"
